...
<html>
	...
	<table class="table table-striped table-hover table-condensed">
			...
			<tbody>
			 <?php foreach($this->tpl_vars["listall"] as $this->tpl_vars["arr"]) { ?>
				<tr>
					<td><a href="index.php?m=project&a=listurl&token=<?php echo $this->tpl_vars["arr"]["project_hash"]; ?>"><?php echo $this->tpl_vars["arr"]["project_name"]; ?></a></td>
					<td><?php echo $this->tpl_vars["arr"]["project_desc"]; ?></td>
					<td><?php echo $this->tpl_vars["arr"]["shellnum"]; ?></td>
					<td><?php echo $this->tpl_vars["arr"]["time"]; ?></td>
					<td>
						<?php if($this->tpl_vars["arr"]['status'] == 0) { ?>
							<span class="label label-info">正在扫描</span>
						<?php } else { ?>
